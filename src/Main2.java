...
public class Main2 {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        LinkedList<Aeropuerto> aerop = leerAeropuertos(20);   
        ...
        origen = aerop.get(0);    //   tuve q  buscar los indices 
        destino = aerop.get(1);  
        System.out.println("ruta minima de aereopurtos entre "+origen.getName()+" y "+destino.getName());
        System.out.println(grafo2.rutaMinima(origen, destino));
        for (Aeropuerto aereo : grafo2.rutaMinima(origen, destino)) {
